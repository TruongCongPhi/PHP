...
<body>
        ...
        <section>
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name_quiz" name="ten_quiz">
                </div>
                <div class="mb-3">
                ...
                <div class="form-group">
                    ...
                    <button style="margin-top:10px" type='button' class="btn btn-primary"
                        onclick="create_element()">Tạo</button>
                </div>
                ...
                <div class="form-check" id="form-check">
                    ...
                    <input type="text" class="form-control remove-element" name="dap_an1">
                    <br><br>
                    <input class="form-check-input" type="radio" value="2" id="flexCheckDefault" name="flag">
                    <input type="text" class="form-control remove-element" name="dap_an2">
                    <br><br>
                    <input class="form-check-input" type="radio" value="3" id="flexCheckDefault" name="flag">
                    <input type="text" class="form-control remove-element" name="dap_an3">
                    <br><br>
                    <input class="form-check-input" type="radio" value="4" id="flexCheckDefault" name="flag">
                    <input type="text" class="form-control remove-element" name="dap_an4">
                    <br><br>
                </div>
                <br><br>
    ...
    function create_element() {
        ...
        for (var i = 1; i <= value; ++i) {
            ...
            var txt_html2 = "<input type=\"text\" class=\"form-control remove-element\" name=\"dap_an" + i + "\">" +
                "<br><br>";
